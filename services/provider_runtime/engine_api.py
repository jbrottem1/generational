    ...
    response = runtime.generate_voice(
        {
            ...
            "settings": settings,
            "mode": mode,
            "voice_id": profile.get("provider_voice_id") or profile.get("voice_id") or settings.get("voice_id") or "",
            "provider_voice_id": profile.get("provider_voice_id") or "",
            "voice": settings.get("voice") or profile.get("voice") or "alloy",
            "model": settings.get("model") or settings.get("model_id") or "",
            "model_id": settings.get("model") or settings.get("model_id") or "",
