...
AGENT_ROSTER: list[dict[str, Any]] = [
    ...
    {"agent": 16, "name": "Animation & Cinematics", "purpose": "Motion / lip-sync plans", "status": "stub", "branch": "feature/animation-engine", "engine_keys": ["animation"], "inputs": ["asset_package"], "outputs": ["animation_package"], "dependencies": ["quality"]},
