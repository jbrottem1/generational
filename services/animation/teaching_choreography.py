...
PLANS: dict[str, list[dict[str, Any]]] = {
    ...
    "foundation_batesian_101": [
        ...
        {"start": 0.18, "end": 0.38, "gesture": "write", "walk": 0.0, "label": "write_term"},
        {"start": 0.38, "end": 0.55, "gesture": "point", "walk": 0.0, "label": "model_mimic"},
        {"start": 0.55, "end": 0.70, "gesture": "present", "walk": 0.0, "label": "examples"},
        {"start": 0.70, "end": 0.82, "gesture": "point", "walk": 0.0, "label": "circle"},
        {"start": 0.82, "end": 0.94, "gesture": "idle", "walk": 0.0, "label": "takeaway"},
        {"start": 0.94, "end": 1.00, "gesture": "idle", "walk": 0.0, "label": "bridge"},
    ],
    "foundation_coral_102": [
        ...
        {"start": 0.18, "end": 0.28, "gesture": "idle", "walk": 0.0, "label": "hold"},
        {"start": 0.28, "end": 0.45, "gesture": "point", "walk": 0.0, "label": "compare"},
        {"start": 0.45, "end": 0.55, "gesture": "idle", "walk": 0.0, "label": "pause"},
        {"start": 0.55, "end": 0.68, "gesture": "present", "walk": 0.0, "label": "warning"},
        {"start": 0.68, "end": 0.80, "gesture": "write", "walk": 0.0, "label": "rhyme_limit"},
        {"start": 0.80, "end": 0.90, "gesture": "point", "walk": 0.0, "label": "safety"},
        {"start": 0.90, "end": 1.00, "gesture": "idle", "walk": 0.0, "label": "takeaway"},
    ],
    "foundation_bluffing_103": [
        ...
        {"start": 0.12, "end": 0.18, "gesture": "idle", "walk": 0.35, "label": "walk_to_board"},
        {"start": 0.18, "end": 0.28, "gesture": "idle", "walk": 0.0, "label": "hold"},
        {"start": 0.28, "end": 0.42, "gesture": "point", "walk": 0.0, "label": "examples"},
        {"start": 0.42, "end": 0.52, "gesture": "idle", "walk": 0.0, "label": "pause"},
        {"start": 0.52, "end": 0.66, "gesture": "present", "walk": 0.0, "label": "monarch"},
        {"start": 0.66, "end": 0.78, "gesture": "write", "walk": 0.0, "label": "arms_race"},
