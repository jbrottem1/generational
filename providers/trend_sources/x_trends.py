"""X (Twitter) trends provider — deterministic placeholder until live API wiring."""
...
class XTrendsProvider(TrendSourceProvider):
    key = "x_trends"
    label = "X Trends (placeholder)"
    platform = "x"
    ...
    def discover(self, topic, category="general", country="US", language="en", limit=3):
        return [
            make_trend(
                ...
                base_volume=40_000, base_confidence=0.6,
            )
