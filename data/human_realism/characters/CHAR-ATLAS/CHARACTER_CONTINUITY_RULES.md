# Character Continuity Rules — Professor Atlas (`CHAR-ATLAS`)

Inherits **HUMAN_REALISM_FRAMEWORK_V1** v1.0.0.

1. Never regenerate this character from scratch.  
2. Inherit shared Human Realism systems; override only identity fields.  
3. Gold-standard reference implementation: `DOCTOR_001` (The Doctor).  
4. This character's reference: `DOCTOR_001`.  
5. Style mode: **cinematic_realism** — cinematic realism.  
