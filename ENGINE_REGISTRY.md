...
| `provider_runtime` | service (Agent 19 + 22) | Sole AI/publishing gateway (`engine_api` + connectors) — see `PROVIDER_INTEGRATION.md`, `PROVIDER_CONNECTORS.md`, `PRODUCTION_READINESS.md` |
